...
/**
 * Classe cujo objetivo é disponibilizar informações básicas como nome e versionamento do projeto.
 * 
 * Pesquisas em:
...
public class InfoProjeto {
	...
	private static final String NOME_PROJETO = "ClinicMedica";
	private static final String NOME_PRODUTO = "Clínica Medica";
	...
	private static final boolean RC          = false; // Define se a versão é a release candidate
