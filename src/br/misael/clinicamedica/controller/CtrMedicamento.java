...
public class CtrMedicamento implements ActionListener, KeyListener ,InternalFrameListener, ListSelectionListener {
	...
	private void gravar() {
		...
		int respostaDialogo = JOptionPane.showConfirmDialog(this.frmMedicamento, "Confirma gravação?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
		...
		// Campos requisitados.
		if(nome.length() == 0) {
			JOptionPane.showMessageDialog(this.frmMedicamento, "Informe os campos requisitados.", "", JOptionPane.WARNING_MESSAGE);
			return;
		}
	...
	private void excluir() {
		...
		int respostaDialogo = JOptionPane.showConfirmDialog(this.frmMedicamento, "Confirma exclusão?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
		...
		if(voMedicamento.getIdMedicamento() == 0) {
			JOptionPane.showMessageDialog(this.frmMedicamento, "Seleciona um registro da tabela para excluir.", "", JOptionPane.WARNING_MESSAGE);
			return;
		}
		...
		try {
			...
			this.inicializar();
			this.atualizarJTable();
			JOptionPane.showMessageDialog(this.frmMedicamento, "Registro excluido.", "", JOptionPane.INFORMATION_MESSAGE);
	...
	private void gerarRelatorioLista() {
		...
		try {
			...
			if(this.voMedicamentos == null) {
				...
				JOptionPane.showMessageDialog(this.frmMedicamento, "Execute uma consulta antes.", "Aviso", JOptionPane.WARNING_MESSAGE);
				return;
			...
			if(this.voMedicamentos.size() == 0) {
				...
				JOptionPane.showMessageDialog(this.frmMedicamento, "Não há registros para exibir o relatório.", "Aviso", JOptionPane.WARNING_MESSAGE);
				return;
			...
			JOptionPane.showMessageDialog(this.frmMedicamento, "Não foi possível abrir o relatório.\n\n" + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
			e.printStackTrace();
